...
if __name__ == "__main__":
    ...
    ap.add_argument("--upper", "-u", type=int, default=20, metavar='GPIO', help="Gpio responsible for setting motor direction")
    ap.add_argument("--lower", "-l", type=int, default=21, metavar='GPIO', help="Pin responsible for setting motor PWM signal")
    ap.add_argument("--pinA", "-a", type=int, default=6, metavar='GPIO', help="Encoder A pin")
    ap.add_argument("--pinB", "-b", type=int, default=13, metavar='GPIO', help="Encoder B pin")
    ap.add_argument("--gpio", "-d", type=int, default=19, metavar='GPIO', help="Gpio responsible for setting motor direction")
    ap.add_argument("--pwm", "-p", type=int, default=26, metavar='GPIO', help="Pin responsible for setting motor PWM signal")
    ap.add_argument("--speed", "-s", type=float, default=0.5, metavar='SPEED', help="Speed you want to drive the motor (-1.0 < spd < 1.0)")
