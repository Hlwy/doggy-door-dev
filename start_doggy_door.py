...
if __name__ == "__main__":
    ...
    ap.add_argument("--gpio", "-d", type=int, default=26, metavar='GPIO', help="Gpio responsible for setting motor direction")
    ap.add_argument("--pwm", "-p", type=int, default=19, metavar='GPIO', help="Pin responsible for setting motor PWM signal")
